...
import com.kicknext.callkit.utils.*
...
@Keep
class CallKit : FlutterPlugin, MethodCallHandler,
    ...
    private fun onAttachedToEngine(context: Context, binaryMessenger: BinaryMessenger) {
        ...
        this.channel = MethodChannel(binaryMessenger, "call_kit")
...
//                    }
                    ...
                    val caller = arguments["caller"] as String
                    val callerName = arguments["caller_name"] as String
            ...
            "reportCallAccepted" -> {
                try {
                    ...
                    val callId = arguments["call_id"] as String
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        parameters["callee_id"] = intent.getStringExtra(EXTRA_CALL_CALLEE_ID)
        parameters["caller_id"] = intent.getStringExtra(EXTRA_CALL_CALLER_ID)
        parameters["caller_name"] = intent.getStringExtra(EXTRA_CALL_CALLEE_NAME)
