...
class AppBarWithMap extends StatefulWidget {
  const AppBarWithMap(
      {required this.map, required this.body, this.onPop, this.isBusy});
  final Widget map;
  ...
  @override
  _AppBarWithMapState createState() => _AppBarWithMapState();
}

class _AppBarWithMapState extends State<AppBarWithMap>
